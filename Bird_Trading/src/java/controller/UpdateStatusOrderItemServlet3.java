 ...
 * @author ASUS
 */
public class UpdateStatusOrderItemServlet3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            System.out.println("gg" + request.getParameter("orderItemId"));
            int orderItemId = Integer.parseInt(orderItemIdString);

            OrderItemDTO orderitem = new OrderItemDTO();
            OrderItemDAO orrderitemdao = new OrderItemDAO();

            boolean success = orrderitemdao.updateStatusByOrderItemIdDelete(orderItemId);

            //lay quanity theo orderitemid
            OrderItemDTO orderitem2 = orrderitemdao.getOrderItem(orderItemId);

            //thay doi lai so luong trong product
            ProductDTO products = new ProductDTO();
            ProductDAO dao = new ProductDAO();
            products = dao.increaseProductQuantityBySttPT(orderitem2.getSttPT(), orderitem2.getQuantity());
