        ...
        <div class="page-wrapper">
            ...
            <nav class="page-sidebar" id="sidebar">
                <div id="sidebar-collapse">
                    ...
                    <ul class="side-menu metismenu">
                        <li>
                            <a href="index.jsp"><i class="sidebar-item-icon fa fa-th-large"></i>
                        ...
                        <li>
                            ...
                            <ul class="nav-2-level collapse">
                                ...
                                <li>
                                    <a href="form_validation.jsp">Tạo sản phẩm mới</a>
                                </li>
                                <li>
                        ...
                        <li class="active">
                            ...
                            <ul class="nav-2-level collapse in">
                                ...
                                <li>
                                    <a class="active" href="AdminHomeServlet">Quản lý sản phẩm</a>
                                </li>
                                <li>
                                    <a href="ShowStoreRegisterServlet">Xác nhận các cửa hàng</a>
                                </li>
                            </ul>
                        </li>
                        <li>
            ...
            <div class="content-wrapper">
                ...
                <div class="page-heading">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="index.jsp"><i class="la la-home font-20"></i></a>
                        </li>
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head">
                            <div class="ibox-title"> <a href="createNewProduct.jsp" class="btn btn-primary">Add Product</a></div>
                        </div>
                        <div class="ibox-body">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="product" items="${products}">
                                        <tr>                                         
                                            ...
                                            <td><img src="${product.image}" alt="Product Image" width="1800px"></td>
                                            <td>
                                                ...
                                                <a href="ProductUpdateServlet?action=edit&productId=${product.productId}" class="btn btn-primary btn-sm">Edit</a>
                                                </br>  </br><a href="DeleteProductServlet?productId=${product.productId}" class="btn btn-danger btn-sm">Delete</a>
                                            </td>
                                        </tr>
