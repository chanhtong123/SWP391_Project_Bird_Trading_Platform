<%-- 
    ...
    Created on : Jun 28, 2023, 9:14:40 PM
    Author     : ASUS
--%>

<%@page import="DTO.StoreDTO"%>
            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-11 col-md-">
                    <div class="row pb-2">
                        ...
                        <% List<StoreDTO> searchResults = (List<StoreDTO>) session.getAttribute("searchResults"); %>

                        <% if (searchResults != null && !searchResults.isEmpty()) { %>

                        <% int totalPages = (int) Math.ceil((double) searchResults.size() / PAGE_SIZE); %>
                        <% int startIndex = (currentPage - 1) * PAGE_SIZE; %>
                        <% int endIndex = Math.min(startIndex + PAGE_SIZE, searchResults.size()); %>

                        <% for (int i = startIndex; i < endIndex; i++) { %>
                        <% StoreDTO store = searchResults.get(i);%>
                        <!-- Hiển thị sản phẩm -->
                        <div id="pagination" class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="<%= store.getImage()%>" alt="" style="width: 150px; height: 250px">
                                    <div class="product-action">

                                        <a class="btn btn-outline-dark btn-square" href="ShopDetailServlet?storeId=<%= store.getStore_id()%>"><i class="fa fa-search"></i></a>
                                    </div>
                                </div>
                                <div class="text-center py-4">
                                    <a class="h6 text-decoration-none text-truncate" href="ShopDetailServlet?storeId=<%= store.getStore_id()%>"></a>
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        <h5 style="color: red"><%= store.getStore_name()%></h5>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mb-1">
                                        <!--                                        <small class="fa fa-star text-primary mr-1"></small>
                                                                                ...
                                                                                <small class="fa fa-star text-primary mr-1"></small>
                                                                                <small class="fa fa-star text-primary mr-1"></small>-->
                                        <small>Địa Chỉ Shop: <%= store.getAddress()%></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <% } else { %>
                        <p class="no-results">Không có shop có từ khóa được tiềm thấy.</p>
                        <% }%>
                    </div>
                </div>
                <!-- Shop Product End -->
