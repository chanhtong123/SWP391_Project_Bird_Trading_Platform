            ...
            <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-item active">
                        <img style="width: 350px; height: 223px" src="${store.image}" alt="Image" >
                    </div>
                ...
                <c:if test="${not empty store}">
                    <div class="h-100 bg-light p-xl-5">
                        <h3 style="color: blue">${store.store_name}</h3>

                        <h6 class="font-weight-semi-bold mb-4" >Số điện thoại: ${store.phone_number}</h3>

                            <h6 class="font-weight-semi-bold mb-4">Địa chỉ Shop: ${store.address}</h3>
                            ...
                            <%
                                final int PAGE_SIZE = 18; // Số sản phẩm hiển thị trên mỗi trang
                            ...
                            <div class="col-lg-12 col-md-8">
                                <div class="row pb-3">
                                    ...
                                    <% int totalPages = (int) Math.ceil((double) product.size() / PAGE_SIZE); %>
                                    <% int startIndex = (currentPage - 1) * PAGE_SIZE; %>
                                    <% int endIndex = Math.min(startIndex + PAGE_SIZE, product.size()); %>

                                    <% for (int i = startIndex; i < endIndex; i++) { %>
                                    <% ProductDTO productList = product.get(i);%>
                                    <!-- Hiển thị sản phẩm -->
                                    <div class="col-lg-2 col-md-12 col-sm-4 pb-4" >
                                        <div class="product-item bg-light mb-12" >
                                            <div class="product-img position-relative overflow-hidden">
                                                <img class="img-fluid w-100" src="<%= productList.getImage()%>" alt="" style="width: 150px; height: 250px">
                                                <div class="product-action">
                                                    <a class="btn btn-outline-dark btn-square" href="CartServlet?action=add&sttPt=<%=productList.getSttPT()%>&productName=<%=productList.getProductName()%>&price=<%=productList.getPrice()%>&quantity=1&imageUrl=<%=productList.getImage()%>&storeid=<%= productList.getStoreId()%>""><i class="fa fa-shopping-cart"></i></a>
                                            ...
                                            <div class="text-center py-4">
                                                <a class="h6 text-decoration-none text-truncate" href="ProductDetailServlet?productId=<%=productList.getProductId()%>"><%= productList.getProductName()%></a>
                                                <div class="d-flex align-items-center justify-content-center mt-2">
                                                    <h5 style="color: red">₫<%= productList.getPrice()%></h5>
                                                ...
                                                <div class="d-flex align-items-center justify-content-center mb-1">
                                                    <!--                                        <small class="fa fa-star text-primary mr-1"></small>
                                                                                            ...
                                                                                            <small class="fa fa-star text-primary mr-1"></small>
                                                                                            <small class="fa fa-star text-primary mr-1"></small>-->
                                                    <small>Số Lượng: <%= productList.getQuantity()%></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <% } else { %>
                                    <h3 style="color: red; text-indent: 28em;">
